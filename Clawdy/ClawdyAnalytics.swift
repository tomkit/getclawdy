...
enum ClawdyAnalytics {

    // MARK: - Setup

    static func configure() {
        let config = PostHogConfig(
            apiKey: "phc_vLAkQjRsTGQtttaxFpBCafT4xNAqXtMYqnk9ZGNjxuVT",
    ...
    /// The 40s onboarding demo interaction where Clawdy points at something.
