...
- **Instant feedback.** A soft blip plays the moment you release the keys, and if the answer is taking a while Clawdy says "hmm, let me look" / "still checking" in its own voice at sensible intervals. The reply always cuts in over a filler; nothing ever plays over anything else.
