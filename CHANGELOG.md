...
### Fixed
- The instant "mm-hm" was being cut off (and the "let me look" fillers and a queued "your page is ready" were being cancelled) by the request's own teardown right after key release. Cues now survive the request start; only a re-press or Stop cancels them.
